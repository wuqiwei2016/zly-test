package com.zpkj.exam.util.alipay.util;

import com.zpkj.exam.util.alipay.config.AlipayConfig;
import com.zpkj.exam.util.alipay.sign.MD5;
...
public class AlipayNotify {
    ...
    private static boolean getSignVeryfy(Map<String, String> params, String sign) {
        ...
        if (AlipayConfig.signType.equals("MD5")) {
            isSign = MD5.verify(preSignStr, sign, AlipayConfig.key, AlipayConfig.inputCharset);
        }
        return isSign;
    }
